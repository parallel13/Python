'''
Задача 36: Напишите функцию def print_operation_table(operation, num_rows=6, num_columns=6), которая принимает в качестве аргумента функцию,
...
print_operation_table(lambda x, y: x - y) #lambda x, y: x - y- operation
